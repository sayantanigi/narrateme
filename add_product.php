  ...
  <section id="content">
    <div class="container Main_Container">
      <div class="block-header">
        <h2>Welcome Back <span style="color:#666; font-weight:400; margin-bottom: 15px !important;"><?php echo $view['first_name'] . " " . $view['last_name'] ?></span><!--<small>Designation</small>--></h2>
      </div>
