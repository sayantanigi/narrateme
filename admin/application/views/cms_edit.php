                ...
                <input type="hidden" name="cms_id" value="<?=$i->id;?>">
                 ...
                 <div class="form-group">
                  ...
                  <div class="form-group">
                    ...
                    <label class="control-label col-md-3">Page Descriptions</label>

                    <div class="col-md-5">

                      <textarea type="text" class="form-control" placeholder="Page Descriptions" rows="6" id="cms_pagetitledes" value="<?php echo $i->cms_pagetitledes;?>" name="cms_pagetitledes"></textarea>
