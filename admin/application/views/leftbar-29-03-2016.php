      ...
      <ul class="page-sidebar-menu  page-header-fixed " data-keep-expanded="false" data-auto-scroll="true" data-slide-speed="200" style="padding-top: 20px">
        ...
        <li class="nav-item start <?//=$group['dashboard']?>"> 
          ...
          <ul class="sub-menu">
            ...
            <li class="nav-item start <?//=$group['dashboard']?>"> <a href="dashboard.php" class="nav-link "> <i class="icon-calendar"></i> <span class="title">Dashboard</span> <span class="selected"></span> </a> </li>
        ...
        <li class="nav-item <?php if($nl=="individual"){?>active open<?php }?>"> 
        ...
        <i class="icon-docs"></i> <span class="title">User Mgmt</span> 
          ...
          <ul class="sub-menu">
            ...
            <li class="nav-item  <?php if($nl=="individual" && $nl2!="view_individual" && $nl2!="view_drug" && $nl2!="add_drug_view"){?>active open<?php }?>"> <a href="<?php echo base_url()?>index.php/individual" class="nav-link "> <span class="title">Add Individual</span> </a> </li>

            

            <li class="nav-item  <?php if($nl2=="view_individual"){?>active open<?php }?>"> <a href="<?php echo base_url()?>index.php/individual/view_individual" class="nav-link "> <span class="title">Manage User </span> </a> </li>

            

            <li class="nav-item  <?php if($nl2=="view_drug"){?>active open<?php }?>"> <a href="<?php echo base_url()?>index.php/individual/view_drug" class="nav-link "> <span class="title">Drug </span> </a> </li>

            

            <li class="nav-item  <?php if($nl2=="add_drug_view"){?>active open<?php }?>"> <a href="<?php echo base_url()?>index.php/individual/add_drug_view" class="nav-link "> <span class="title">Add Drug </span> </a> </li>
        ...
        <span class="arrow <?//=$arrowopen['tools']?>"></span> </a>
          ...
          <ul class="sub-menu">
            ...
            <li class="nav-item <?//=$activepage['settings']?>"> <a href="settings.php" class="nav-link"> <i class="icon-bar-chart"></i> Settings </a> </li>

            <li class="nav-item <?//=$activepage['adminprofile']?>"> <a href="adminprofile.php" class="nav-link"> <i class="icon-user"></i> Admin Profile </a> </li>
