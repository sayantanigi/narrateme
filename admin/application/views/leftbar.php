...
<div class="page-sidebar navbar-collapse collapse">
      ...
      <ul class="page-sidebar-menu  page-header-fixed " data-keep-expanded="false" data-auto-scroll="true" data-slide-speed="200" style="padding-top: 20px">
        ...
        <li class="nav-item start <?//=$group['dashboard']?>"> 
          ...
          <ul class="sub-menu">
            ...
            <li class="nav-item start <?//=$group['dashboard']?>"> <a href="<?php echo base_url();?>home" class="nav-link "> <i class="icon-calendar"></i> <span class="title">Dashboard</span> <span class="selected"></span> </a> </li>
        ...
        <i class="icon-docs"></i> <span class="title">CMS Mgmt</span> 
          ...
          <ul class="sub-menu">
            ...
            <li class="nav-item  <?php if($nl2=="add_cms"){?>active open<?php }?>"> <a href="<?php echo base_url()?>cms/add_cms" class="nav-link "> <span class="title">Add Cms Page </span> </a> </li>
        ...
        <i class="icon-docs"></i> <span class="title">FAQ Mgmt</span> 
          ...
          <ul class="sub-menu">
            <li class="nav-item  <?php if($nl2=="add_faq"){?>active open<?php }?>"> <a href="<?php echo base_url()?>faq/add_faq" class="nav-link "> <span class="title">Add FAQ </span> </a> </li>

            <li class="nav-item  <?php if($nl=="faq" && $nl2!="add_faq"){?>active open<?php }?>"> <a href="<?php echo base_url()?>faq/view_faq" class="nav-link "> <span class="title">Manage FAQ</span> </a> </li>
          </ul>
        </li>
    ...
    <li class="nav-item  <?php if($nl2=="product_type_add_form"){?>active open<?php }?>"> <a href="<?php echo base_url();?>product_type/product_type_add_form" class="nav-link "> <span class="title">Add Product Type</span> </a> </li>
    
      <li class="nav-item  <?php if($nl=="show_product_type"  ){?>active open<?php }?>"> <a href="<?php echo base_url();?>product_type/show_product_type" class="nav-link "> <span class="title">Manage Product Type</span> </a> </li>
      
      <li class="nav-item  <?php if($nl2=="product_add_form"){?>active open<?php }?>"> <a href="<?php echo base_url();?>product/product_add_form" class="nav-link "> <span class="title">Add Product</span> </a> </li>
    
      <li class="nav-item  <?php if($nl=="show_product"  ){?>active open<?php }?>"> <a href="<?php echo base_url();?>product/show_product" class="nav-link "> <span class="title">Manage Product</span> </a> </li>
        ...
        <span class="arrow <?//=$arrowopen['tools']?>"></span> </a>
          ...
          <ul class="sub-menu">
            ...
            <li class="nav-item"> <a href="<?php echo base_url()?>home/logout" class="nav-link"> <i class="icon-key"></i> Logout </a> </li>
