                                    ...
                                    if (!empty($ecms)) {
                                        ...
                                        foreach ($ecms as $i) {
                                            ...
                                            <tr class="table table-striped table-bordered table-hover table-checkable order-column dt-responsive"
                                                ...
                                                <td>
                                                    <?php if ($i->cmsimg == "") { ?>No Image
                                                    <?php } else { ?><img
                                                            src="<?php echo base_url() ?>/uploads/<?php echo $i->cmsimg; ?>"
                                                            width="30" height="30" />
                                                    <?php } ?>
                                                </td>
                                                ...
                                                <td style="max-width:50px;"><a
                                                        ...
                                                        href="<?php echo base_url() ?>index.php/cms/show_individual_cms_id/<?php echo $i->id; ?>">Edit</a>
                                                </td>

                                                <td><a class="btn green btn-sm btn-outline sbold uppercase"
                                                        href="<?php echo base_url() ?>index.php/cms/delete_cms/<?php echo $i->id ?>"
