                    ...
                    <div class="portlet box blue-hoki">
                        ...
                        <div class="portlet-body form">
                            ...
                            if (!empty($esettings)) {
                                ...
                                ?>
                                <form action="<?php echo base_url() . 'settings/edit_settings' ?>"
                                    class="form-horizontal form-bordered" method="post">
                                    <input type="hidden" name="id" id="id" value="<?php echo $i->id ?>">
                                    <div class="form-body">
                                        <div class="form-group">
                                            <label class="control-label col-md-3">Google Analytics <span
                                                    style="font-size:12px;">(Without
                                                    &lt;script&gt;...&lt;/script&gt; Tags)</span></label>
                                            <div class="col-md-9">
