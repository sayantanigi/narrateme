                                        ...
                                        foreach ($ecms as $i) {
                                            ...
                                            <tr class="odd gradeX">
                                                ...
                                                <td><a class="btn green btn-sm btn-outline sbold uppercase"
                                                        href="<?php echo base_url() ?>index.php/individual/show_individual_id/<?php echo $i->id ?>">Edit</a>
                                                </td>
                                                <td><a class="btn green btn-sm btn-outline sbold uppercase"
                                                        href="<?php echo base_url() ?>index.php/individual/delete_individual/<?php echo $i->id ?>"
