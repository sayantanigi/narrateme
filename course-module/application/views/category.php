                    ...
                    <!-- <div class="col-form">
                        ...
                        <div class="field-select">
                            <select class="select-option" onchange="cityget(this);">
                                ...
                                <?php /*if (is_array($country) && count($country) > 0) {
                                    ...
                                    <span class="amount-price">48.00 hrs</span>
                                            ...
                                            <div class="both-bt">
                                                <a href="<?= base_url(); ?>courses/comingsooncoursedetails/<?php echo $i->course_id; ?>"
                                                    class="button-default">Course Detail </a> <a href="#"
                                                    class="button-default orange">Register Your Interest </a>
                                            </div>
                                        </div>
                                    </div>
                                </li>
                                    ...
                                    <ul class="gform_fields">
                                        ...
                                        <li class="gfield">
                                            ...
                                            <div class="ginput_container ginput_container_textarea">
                                                <textarea name="" class="textarea medium"
