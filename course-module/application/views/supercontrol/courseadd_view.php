                                    ...
                                    <div class="portlet-body form">
                                        <form action="<?php echo base_url() . 'supercontrol/course/add_my_course' ?>" class="form-horizontal" method="post" enctype="multipart/form-data" onsubmit="check()">
                                            <div class="form-body">
                                                ...
                                                <div class="form-group">
                                                    <b><label class="col-md-3 control-label">Select Category *</label></b>
                                                    <div class="col-md-8">
                                                ...
                                                <div class="form-group">
                                                    <b><label class="col-md-3 control-label">Course Name *</label></b>
                                                    <div class="col-md-8">
                                                        <input type="text" name="course_name" required="" id="title"
                                                            class="form-control" placeholder="Course Name"
                                                            onkeyup="leftTrim(this)" />
                                                        <label id="errorBox"></label>
                                                    </div>
                                                </div>
                                                <div class="form-group">
                                                ...
                                                <div class="form-group">
                                                    <b><label class="col-md-3 control-label">Course Certificate*</label></b>
                                                    <div class="col-md-8">
                                                ...
                                                <div class="form-group">
                                                    <b><label class="col-md-3 control-label">Who should Attend</label></b>
                                                    <div class="col-md-8">
                                                ...
                                                <div class="form-group">
                                                    <b><label class="col-md-3 control-label">Start Date *</label></b>
                                                    <div class="col-md-8">
                                                ...
                                                <div class="form-group">
                                                    <b><label class="col-md-3 control-label">End Date *</label></b>
                                                    <div class="col-md-8">
                                                ...
                                                <div class="form-group">
                                                    <b><label class="col-md-3 control-label">Course Level *</label></b>
                                                    <div class="col-md-8">
                                                ...
                                                <!--<div class="form-group">
                                                    <label class="col-md-3 control-label"><b>Shift Details *</b></label>
