...
?>
<style>
    .page-sidebar .page-sidebar-menu>li>a, .page-sidebar-closed.page-sidebar-fixed .page-sidebar:hover .page-sidebar-menu>li>a { padding: 10px 0 !important;}
    ...
    <ul class="page-sidebar-menu  page-header-fixed " data-keep-expanded="false" data-auto-scroll="true"
        ...
        <!-- <li class="nav-item <?php if ($nl == "cms") { ?>active open<?php } ?>">
            <a href="javascript:;" class="nav-link nav-toggle">
                <i class="fa fa-pagelines"></i> <span class="title">Content Management</span>
        ...
        <li class="nav-item <?php if ($nl == "country") { ?>active open<?php } ?>">
            <a href="javascript:;" class="nav-link nav-toggle"> <i class="fa fa-keyboard-o"></i> <span class="title">Country Management</span> <span class="addindividual"></span> <span class="arrow addindividual"></span> </a>
            <ul class="sub-menu">
        ...
        <li class="nav-item <?php if ($nl == "city") { ?>active open<?php } ?>">
            <a href="javascript:;" class="nav-link nav-toggle"> <i class="fa fa-keyboard-o"></i> <span class="title">City Management</span> <span class="addindividual"></span> <span class="arrow addindividual"></span> </a>
            <ul class="sub-menu">
        ...
        <li class="nav-item <?php if ($nl == "location") { ?>active open<?php } ?>">
            <a href="javascript:;" class="nav-link nav-toggle"> <i class="fa fa-question-circle"></i> <span class="title">Location Management</span> <span class="addindividual"></span> <span class="arrow addindividual"></span> </a>
            <ul class="sub-menu">
        ...
        <li class="nav-item <?php if ($nl == "member") { ?>active open<?php } ?>">
            <a href="javascript:;" class="nav-link nav-toggle"> <i class="fa fa-users"></i> <span class="title">Member Mgmt</span> <span class="addindividual"></span> <span class="arrow addindividual"></span> </a>
            <ul class="sub-menu">
        ...
        <li class="nav-item <?php if ($nl == "batch" || $nl == "location" || $nl == "lesson") { ?>active open<?php } ?>">
            <a href="javascript:;" class="nav-link nav-toggle"> <i class="fa fa-sitemap"></i> <span class="title">Course Batch  Mgmt</span> <span class="addindividual"></span> <span class="arrow addindividual"></span> </a>
            <ul class="sub-menu">
        ...
        <li class="nav-item <?php if ($nl == "coursequery") { ?>active open<?php } ?>">
            <a href="javascript:;" class="nav-link nav-toggle"> <i class="fa fa-info-circle"></i> <span class="title">Course Query Mgmt</span> <span class="addindividual"></span> <span class="arrow addindividual"></span> </a>
            <ul class="sub-menu">
        ...
        <li class="nav-item <?php if ($nl == "discount") { ?>active open<?php } ?>">
            <a href="javascript:;" class="nav-link nav-toggle"><i class="icon-docs"></i><span class="title">Discount Mgmt</span> <span class="addindividual"></span><span class="arrow addindividual"></span></a>
            <ul class="sub-menu">
        ...
        <li class="nav-item <?php if ($nl == "timeline" || $nl == "partners") { ?>active open<?php } ?>">
            <a href="javascript:;" class="nav-link nav-toggle"> <i class="fa fa-home"></i> <span class="title">About Us Mgmt</span> <span class="arrow"></span> </a>
            <ul class="sub-menu">
        ...
        <li class="nav-item <?php if ($nl == "faq") { ?>active open<?php } ?>">
            <a href="javascript:;" class="nav-link nav-toggle"> <i class="fa fa-question-circle"></i> <span class="title">FAQ Managements</span> <span class="addindividual"></span> <span class="arrow addindividual"></span> </a>
            <ul class="sub-menu">
        ...
        <li class="nav-item <?php if ($nl == "testimonial") { ?>active open<?php } ?>">
            <a href="javascript:;" class="nav-link nav-toggle"> <i class="fa fa-rss"></i> <span class="title">Testimonial Mgmt</span> <span class="addindividual"></span> <span class="arrow addindividual"></span> </a>
            <ul class="sub-menu">
        ...
        <li class="nav-item <?php if ($nl == "contact") { ?>active open<?php } ?>">
            <a href="javascript:;" class="nav-link nav-toggle"> <i class="fa fa-envelope-square"></i> <span class="title">Contact Mgmt</span> <span class="addindividual"></span> <span class="arrow addindividual"></span> </a>
            <ul class="sub-menu">
        ...
        <li class="nav-item <?php if ($nl == "news") { ?>active open<?php } ?>">
            <a href="javascript:;" class="nav-link nav-toggle"> <i class="fa fa-newspaper-o"></i> <span class="title">News Managements</span> <span class="addindividual"></span> <span class="arrow addindividual"></span> </a>
            <ul class="sub-menu">
        ...
        <li class="nav-item <?php if ($nl == "announcement") { ?>active open<?php } ?>">
            <a href="javascript:;" class="nav-link nav-toggle"> <i class="fa fa-bullhorn"></i> <span class="title">Announcement Mgmt</span> <span class="addindividual"></span> <span class="arrow addindividual"></span> </a>
            <ul class="sub-menu">
        ...
        <li class="nav-item <?php if ($nl == "newsletter") { ?>active open<?php } ?>">
            <a href="javascript:;" class="nav-link nav-toggle"> <i class="fa fa-check-square"></i> <span class="title">News Letter Mgmt</span> <span class="addindividual"></span> <span class="arrow addindividual"></span> </a>
            <ul class="sub-menu">
        ...
        <li class="nav-item <?php if ($nl == "adminprofile" || $nl == "settings" || $nl == "user") { ?>active open<?php } ?>">
            <a href="javascript:;" class="nav-link nav-toggle"> <i class="fa fa-cogs"></i> <span class="title">Tools</span> <span class="addindividual"></span> <span class="arrow addindividual"></span> </a>
            <ul class="sub-menu">
        ...
        <li class="nav-item <?php if ($nl == "country") { ?>active open<?php } ?>">
            <a href="javascript:;" class="nav-link nav-toggle"> <i class="fa fa-keyboard-o"></i> <span class="title">Data Managements</span> <span class="addindividual"></span> <span class="arrow addindividual"></span> </a>
            <ul class="sub-menu">
        ...
        <li class="nav-item <?php if ($nl == "team") { ?>active open<?php } ?>">
            <a href="javascript:;" class="nav-link nav-toggle"> <i class="fa fa-keyboard-o"></i> <span class="title">Team Management</span> <span class="addindividual"></span> <span class="arrow addindividual"></span> </a>
            <ul class="sub-menu">
        ...
        <li class="nav-item <?php if ($nl == "blog") { ?>active open<?php } ?>">
            <a href="javascript:;" class="nav-link nav-toggle"> <i class="fa fa-keyboard-o"></i> <span class="title">Blog Management</span> <span class="addindividual"></span> <span class="arrow addindividual"></span> </a>
            <ul class="sub-menu">
        ...
        <li class="nav-item <?php if ($nl == "category") { ?>active open<?php } ?>">
            <a href="javascript:;" class="nav-link nav-toggle"> <i class="fa fa-keyboard-o"></i> <span class="title">Category Management</span> <span class="addindividual"></span><span class="arrow addindividual"></span> </a>
            <ul class="sub-menu">
        ...
        <li class="nav-item <?php if ($nl == "level") { ?>active open<?php } ?>">
            ...
            <ul class="sub-menu">
            <li class="nav-item  <?php if ($nl == "level_add_form") { ?>active open<?php } ?>"> <a href="<?php echo base_url(); ?>supercontrol/level/level_add_form" class="nav-link "> <span class="title">Add Level</span> </a> </li>
        ...
        <li class="nav-item <?php if ($nl == "course" || $nl == "batch" || $nl == "lesson") { ?>active open<?php } ?>">
            <a href="javascript:;" class="nav-link nav-toggle"> <i class="fa fa-th-list"></i> <span class="title">Course Management</span> <span class="addindividual"></span> <span class="arrow addindividual"></span> </a>
            <ul class="sub-menu">
        ...
        <li class="nav-item <?php if ($nl == "paid") { ?>active open<?php } ?>">
            <a href="javascript:;" class="nav-link nav-toggle"> <i class="fa fa-certificate"></i> <span class="title">Booking Management</span> <span class="addindividual"></span> <span class="arrow addindividual"></span> </a>
            <ul class="sub-menu">
        ...
        <li class="nav-item <?php if ($nl == "student") { ?>active open<?php } ?>">
            <a href="javascript:;" class="nav-link nav-toggle"> <i class="fa fa-certificate"></i> <span class="title">Student Management</span> <span class="addindividual"></span> <span class="arrow addindividual"></span> </a>
            <ul class="sub-menu">
        ...
        <li class="nav-item <?php if ($nl == "instructor") { ?>active open<?php } ?>">
            <a href="javascript:;" class="nav-link nav-toggle"> <i class="fa fa-certificate"></i> <span class="title">Instructor Management</span> <span class="addindividual"></span> <span class="arrow addindividual"></span> </a>
            <ul class="sub-menu">
