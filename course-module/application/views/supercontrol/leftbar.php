...
<div class="page-sidebar navbar-collapse collapse">
    <ul class="page-sidebar-menu  page-header-fixed " data-keep-expanded="false" data-auto-scroll="true"
        ...
        <li class="nav-item start "> <a href="<?php echo base_url() ?>supercontrol/home" class="nav-link "> <span
                    class="title">Dashboard</span> </a>
            <ul class="sub-menu">
                <li class="nav-item start "> <a href="<?php echo base_url() ?>supercontrol/home" class="nav-link "> <i
                            class="icon-list"></i> <span class="title">View Dashboard</span> </a> </li>
            </ul>
        </li>
        <li class="heading">
      ...
      <ul class="sub-menu">
        ...
        <li class="nav-item <?php if ($nl == "course" || $nl == "batch" || $nl == "lesson") { ?>active open<?php } ?>"> <a
                href="javascript:;" class="nav-link nav-toggle"> <i class="fa fa-th-list"></i> <span
                    class="title">Course Mgmt</span> <span class="addindividual"></span> <span
                    class="arrow addindividual"></span> </a>
            <ul class="sub-menu">
                <li class="nav-item  <?php if ($nl2 == "course") { ?>active open<?php } ?>"> <a
                        href="<?php echo base_url(); ?>supercontrol/course/add_course" class="nav-link "> <span
                            class="title">Add Course</span> </a> </li>
                <li class="nav-item  <?php if ($nl == "show_course") { ?>active open<?php } ?>"> <a
                        href="<?php echo base_url(); ?>supercontrol/course/show_course" class="nav-link "> <span
                            class="title">Upcoming Courses </span> </a> </li>
                <li class="nav-item  <?php if ($nl == "show_course") { ?>active open<?php } ?>"> <a
                        href="<?php echo base_url(); ?>supercontrol/course/comingsoon_course" class="nav-link "> <span
                            class="title">Coming Soon courses </span> </a> </li>
...
<li class="nav-item <?php if ($nl == "newsletter") { ?>active open<?php } ?>"> <a href="javascript:;" class="nav-link nav-toggle"> <i class="fa fa-check-square"></i> <span class="title">News Letter Mgmt</span> <span class="addindividual"></span> <span class="arrow addindividual"></span> </a>
  ...
  <ul class="sub-menu">
    ...
    <li class="nav-item  <?php if ($nl2 == "logout") { ?>active open<?php } ?>"> <a href="<?php echo base_url() ?>supercontrol/main/logout" class="nav-link "> <span class="title">Log out</span> </a> </li>
        ...
        <li class="nav-item <?php if ($nl == "country") { ?>active open<?php } ?>"> <a href="javascript:;"
                class="nav-link nav-toggle"> <i class="fa fa-keyboard-o"></i> <span class="title">Country Mgmt</span>
                <span class="addindividual"></span> <span class="arrow addindividual"></span> </a>
            <ul class="sub-menu">
                <li class="nav-item  <?php if ($nl2 == "country") { ?>active open<?php } ?>"> <a
                        href="<?php echo base_url(); ?>supercontrol/country" class="nav-link "> <span class="title">Add
                            country</span> </a> </li>
                <li class="nav-item  <?php if ($nl2 == "show_country") { ?>active open<?php } ?>"> <a
                        href="<?php echo base_url(); ?>supercontrol/country/show_country" class="nav-link "> <span
                            class="title">Manage country</span> </a> </li>
            </ul>
        </li>

        <li class="nav-item <?php if ($nl == "city") { ?>active open<?php } ?>"> <a href="javascript:;"
                class="nav-link nav-toggle"> <i class="fa fa-keyboard-o"></i> <span class="title">City Mgmt</span> <span
                    class="addindividual"></span> <span class="arrow addindividual"></span> </a>
            <ul class="sub-menu">
                <li class="nav-item  <?php if ($nl2 == "city") { ?>active open<?php } ?>"> <a
                        href="<?php echo base_url(); ?>supercontrol/city" class="nav-link "> <span class="title">Add
                            City</span> </a> </li>
                <li class="nav-item  <?php if ($nl2 == "show_city") { ?>active open<?php } ?>"> <a
                        href="<?php echo base_url(); ?>supercontrol/city/show_city" class="nav-link "> <span
        ...
        <li class="nav-item <?php if ($nl == "location") { ?>active open<?php } ?>"> <a href="javascript:;"
                class="nav-link nav-toggle"> <i class="fa fa-question-circle"></i> <span class="title">Location
                    Managements</span> <span class="addindividual"></span> <span class="arrow addindividual"></span>
            </a>
            <ul class="sub-menu">
                <li class="nav-item  <?php if ($nl2 == "location_add_form") { ?>active open<?php } ?>"> <a
                        href="<?php echo base_url(); ?>supercontrol/location/location_add_form" class="nav-link "> <span
                            class="title">Add Location</span> </a> </li>
                <li class="nav-item  <?php if ($nl2 == "show_location") { ?>active open<?php } ?>"> <a
                        href="<?php echo base_url(); ?>supercontrol/location/show_location" class="nav-link "> <span
                            class="title">Manage Location</span> </a> </li>
            </ul>
        </li>



        <li class="nav-item <?php if ($nl == "mode") { ?>active open<?php } ?>"> <a href="javascript:;"
                class="nav-link nav-toggle"> <i class="fa fa-certificate"></i> <span class="title">Mode Mgmt</span>
                <span class="addindividual"></span> <span class="arrow addindividual"></span> </a>
            <ul class="sub-menu">
                <li class="nav-item  <?php if ($nl == "show_mode") { ?>active open<?php } ?>"> <a
                        href="<?php echo base_url(); ?>supercontrol/mode/show_mode" class="nav-link "> <span
                            class="title">Manage Mode</span> </a> </li>
            </ul>
        </li>


        <li class="nav-item <?php if ($nl == "category") { ?>active open<?php } ?>"> <a href="javascript:;"
                class="nav-link nav-toggle"> <i class="fa fa-keyboard-o"></i> <span class="title">Category Mgmt</span>
                <span class="addindividual"></span> <span class="arrow addindividual"></span> </a>
            <ul class="sub-menu">
                <li class="nav-item  <?php if ($nl2 == "category") { ?>active open<?php } ?>"> <a
                        href="<?php echo base_url(); ?>supercontrol/category" class="nav-link "> <span class="title">Add
                            Category</span> </a> </li>
                <li class="nav-item  <?php if ($nl2 == "show_category") { ?>active open<?php } ?>"> <a
                        href="<?php echo base_url(); ?>supercontrol/category/show_category" class="nav-link "> <span
                            class="title">Manage Category</span> </a> </li>
            </ul>
        </li>

        <li class="nav-item <?php if ($nl == "level") { ?>active open<?php } ?>"> <a href="javascript:;"
                class="nav-link nav-toggle"> <i class="fa fa-certificate"></i> <span class="title">Level Mgmt</span>
                <span class="addindividual"></span> <span class="arrow addindividual"></span> </a>
            <ul class="sub-menu">
                <li class="nav-item  <?php if ($nl == "show_level") { ?>active open<?php } ?>"> <a
                        href="<?php echo base_url(); ?>supercontrol/level/show_level" class="nav-link "> <span
                            class="title">Manage Level</span> </a> </li>
            </ul>
        </li>
      ...
      <ul class="sub-menu">
        ...
        <li class="nav-item <?php if ($nl == "book") { ?>active open<?php } ?>"> <a href="javascript:;"
                class="nav-link nav-toggle"> <i class="fa fa-certificate"></i> <span class="title">Booking
                    Management</span> <span class="addindividual"></span> <span class="arrow addindividual"></span> </a>
            <ul class="sub-menu">
                <li class="nav-item  <?php if ($nl == "show_level") { ?>active open<?php } ?>"> <a
                        href="<?php echo base_url(); ?>supercontrol/level/show_level" class="nav-link "> <span
                            class="title">Booking List</span> </a> </li>
            </ul>
        </li>
        <li class="nav-item <?php if ($nl == "student") { ?>active open<?php } ?>"> <a href="javascript:;"
                class="nav-link nav-toggle"> <i class="fa fa-certificate"></i> <span class="title">Student
                    Management</span> <span class="addindividual"></span> <span class="arrow addindividual"></span> </a>
            <ul class="sub-menu">
                <li class="nav-item  <?php if ($nl == "show_level") { ?>active open<?php } ?>"> <a
                        href="<?php echo base_url(); ?>supercontrol/level/show_level" class="nav-link "> <span
                            class="title">Student List</span> </a> </li>
            </ul>
        </li>
        <li class="nav-item <?php if ($nl == "instructor") { ?>active open<?php } ?>"> <a href="javascript:;"
                class="nav-link nav-toggle"> <i class="fa fa-certificate"></i> <span class="title">Instructor
                    Management</span> <span class="addindividual"></span> <span class="arrow addindividual"></span> </a>
            <ul class="sub-menu">
                <li class="nav-item  <?php if ($nl == "show_level") { ?>active open<?php } ?>"> <a
                        href="<?php echo base_url(); ?>supercontrol/level/show_level" class="nav-link "> <span
                            class="title">Instructor List</span> </a> </li>
            </ul>
        </li>
    </ul>
</div>