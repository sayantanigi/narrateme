                                            ...
                                            <div class="form-body">
                                                    ...
                                                    <div class="col-md-9">
                                                        <div class="fileinput fileinput-new" data-provides="fileinput">
                                                            ...
                                                            <div>
                                                                ...
                                                                <a href="javascript:;" class="btn red fileinput-exists" data-dismiss="fileinput"> Remove </a> </div>
                                                        </div>
                                                ...
                                                <div class="form-group">
                                                    ...
                                                    <div class="col-md-8">
                                                        ...
                                                        <?php echo form_error('mode_title'); ?> </div>
                                                </div>
                                                <div id="err2" style="color:#f00;text-align:center;"></div>
                                                <div class="form-group">
                                                    <label class="control-label col-md-3">Mode Description</label>
                                                    <div class="col-md-8">
                                                        <?php echo form_textarea(array('id' => 'pagedes', 'name' => 'mode_desc', 'class' => 'form-control')); ?>
                                                        <?php echo form_error('mode_desc'); ?> </div>
                                                </div>
                                            </div>
