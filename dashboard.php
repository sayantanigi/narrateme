		...
		<div class="container Main_Container">
			...
			<div id="profile-main" class="card">
				...
				<div class="pm-body clearfix">
					<div class="pmb-block">
						<a href="searchforuser.php" class="btn btn-danger" style="background: #576042; padding: 0 20px; height: 40px; border-radius: 50px; font-size: 14px; margin-left: 10px; display: flex; align-items: center; justify-content: center; width: max-content; box-shadow: none;">Search User</a>
						<div class="pmbb-header">
							<div class="panel-group" data-collapse-color="teal" id="accordionTeal" role="tablist" aria-multiselectable="true">
								<div class="panel panel-collapse">
									...
									<div id="accordionTeal-one" class="collapse in" role="tabpanel" style="margin-top: 15px;">
