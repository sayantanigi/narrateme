                          ...
                          <div class="pmbb-body p-l-0"> 
                            <div class="pmbb-view">
                             ...
                             <dl class="dl-horizontal">
                              ...
                              <dl class="dl-horizontal">
                                <dt>Address</dt>
                                <dd><?=$view['address']?><span style="margin-left: 200px;color:green;"><?php if($view['addr_st'] == '1'){ echo "<i class='fa fa-globe' aria-hidden='true'></i>&nbsp Public"; } elseif($view['addr_st'] == '2') { echo "<i class='fa fa-lock' aria-hidden='true'></i>&nbsp Private";} else {echo "<i class='fas fa-user' aria-hidden='true'></i>&nbsp Friends";}?></span></dd>
                              </dl>
                              <dl class="dl-horizontal">
                                <dt>Telephone No.</dt>
                                <dd><?=$view['phone_no']?> <span style="margin-left: 200px;color:green;"><?php if($view['phone_st'] == '1'){ echo "<i class='fa fa-globe' aria-hidden='true'></i>&nbsp Public"; } elseif($view['phone_st'] == '2') { echo "<i class='fa fa-lock' aria-hidden='true'></i>&nbsp Private";}else {echo "<i class='fa fa-user' aria-hidden='true'></i>&nbsp Friends";}?></span></dd>
                              </dl>
                              
                              <dl class="dl-horizontal">
                                <dt>E-mail Address</dt>
                                <dd><?=$view['email']?><span style="margin-left: 200px;color:green;"><?php if($view['email_st'] == '1'){ echo "<i class='fa fa-globe' aria-hidden='true'></i>&nbsp Public"; } elseif($view['email_st'] == '2') { echo "<i class='fa fa-lock' aria-hidden='true'></i>&nbsp Private";}else{echo "<i class='fa fa-user' aria-hidden='true'></i>&nbsp Friends";}?></span></dd>
                              </dl>
                              <dl class="dl-horizontal">
                                <dt>Text, Instant, SMS , or MMS message number</dt>
                                <dd><?=$view['text_no']?><span style="margin-left: 200px;color:green;"><?php if($view['text_no_st'] == '1'){ echo "<i class='fa fa-globe' aria-hidden='true'></i>&nbsp Public"; } elseif($view['text_no_st'] == '2') { echo "<i class='fa fa-lock' aria-hidden='true'></i>&nbsp Private";}else{echo "<i class='fa fa-user' aria-hidden='true'></i>&nbsp Friends";}?></span></dd>
                              </dl>
                              <dl class="dl-horizontal">
                                <dt>IP Address</dt>
                              ...
                              <a id="leftactivate" class="btn btn-primary waves-effect">Add Profiles</a>
                              </dl>-->
