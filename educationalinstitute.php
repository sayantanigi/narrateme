      ...
      <div class="block-header">
        <h2>Welcome Back <span style="color:#666; font-weight:400;"><?php echo $view['first_name'] . " " . $view['last_name'] ?></span>
          <small><?php if ($view['ind'] == 1) {
                  ...
                  if ($view['edu'] == 1) {
                    echo "Educational Institute,";
                  }
                  if ($view['edu'] == 1) {
                    echo "Instructional Facility or School";
                  }
                  ?></small>
        </h2>
      </div>
          ...
          <div class="pmb-block">
            ...
            <div class="pmbb-header">
              <div class="panel-group" data-collapse-color="teal" id="accordionTeal" role="tablist" aria-multiselectable="true">
                <div>
                  <h4 id="gen" class="btn btn-success"><a style="cursor:pointer; color:#FFF;">General Information</a><i class="fa fa-plus-circle" aria-hidden="true"></i></h4>
                </div>
                        ...
                        <div class="pmb-block p-10  m-b-0">
                          <div class="pmbb-body p-l-0">
                            <?php if (@$_REQUEST['editgeneralinfo'] == '') { ?>
                              <div class="pmbb-view">
                                <ul class="actions" style="position: relative; display: flex; align-items: center; justify-content: end;">
                                  <li class="dropdown open">
                                    <ul class="dropdown-menu dropdown-menu-right" style="min-width: 62px; position: relative; margin: 0;">
                                    ...
                                    <form onsubmit="return instruvalde();" action="<?= $_SERVER['PHP_SELF'] ?>" method="post">
                                      ...
                                      <dl class="dl-horizontal">
                                        ...
                                        <dd>
                                          ...
                                          <span id="errorinsnamea" style="color:#ff0000;">&nbsp;</span>
                                        </dd>
                                      </dl>
                                    ...
                                    <form onsubmit="return editinstruvalde();" action="<?= $_SERVER['PHP_SELF'] ?>" method="post">
                                      ...
                                      <dl class="dl-horizontal">
                                        ...
                                        <dd>
                                          ...
                                          <span id="errorinstrunameedit" style="color:#ff0000;">&nbsp;</span>
                                        </dd>
                                      </dl>
                                                  ...
                                                  <thead>
                                                    ...
                                                    ?>
                                                      <tr>
                                                        ...
                                                        <td><?php if ($fetchinslist['status'] == 1) {
                                                              echo "Public";
                                                            } else if ($fetchinslist['status'] == 2) {
                                                              echo "Private";
                                                            } else {
                                                              echo "Friends";
                                                            } ?></td>
                            ...
                            <?php } else { ?>
                              <form name="generalinfoform" id="generalinfoform" onsubmit="return check9();" action="<?= $_SERVER['PHP_SELF'] ?>" method="post" style="margin-top: 15px;">
                                <input type="hidden" name="generalinfopanel" value="1" />
                                ...
                                <div class="pmbb-edit" style="display:block;">
                                  <dl class="dl-horizontal">
                                    ...
                                    <dd>
                                      ...
                                      <span id="generalinfo_error3" style="color:#ff0000;">&nbsp;</span>
                                    </dd>
                                  </dl>
                                  <dl class="dl-horizontal">
                            ...
                            <?php } ?>
                            <form name="generalinfoform" id="generalinfoform" onsubmit="return Submitgeneralinfo3();" action="<?= $_SERVER['PHP_SELF'] ?>" method="post" style="margin-top: 15px;">
                              <input type="hidden" name="generalinfopanel" value="1" />
                              <div class="pmbb-edit">
                                <dl class="dl-horizontal">
                                  <dt class="p-t-10">Name*</dt>
                ...
                <div>
                  <h4 id="prog" class="btn btn-success"><a style="cursor:pointer; color:#FFF;">Schools & Programs</a><i class="fa fa-plus-circle" aria-hidden="true"></i></h4>
                </div>
                      ...
                      <div class="panel-body">
                        <div class="pmb-block p-10  m-b-0">
                          <div class="pmbb-body p-l-0">
                                    ...
                                    <form onsubmit="return crsvalde();" action="<?= $_SERVER['PHP_SELF'] ?>" method="post">
                                      ...
                                      <dl class="dl-horizontal">
                                        ...
                                        <dd>
                                          ...
                                          <span id="errorcrs" style="color:#ff0000;">&nbsp;</span>
                                        </dd>
                                      </dl>
                                      <div class="m-t-30">
                                    ...
                                    <form onsubmit="return editcrsvalde();" action="<?= $_SERVER['PHP_SELF'] ?>" method="post">
                                      ...
                                      <dl class="dl-horizontal">
                                        ...
                                        <dd>
                                          ...
                                          <span id="errorcrsname" style="color:#ff0000;">&nbsp;</span>
                                        </dd>
                                      </dl>
                                    ...
                                    <form onsubmit="return crsdetvalde();" action="<?= $_SERVER['PHP_SELF'] ?>" method="post">
                                      ...
                                      <dl class="dl-horizontal">
                                        ...
                                        <dd>
                                          ...
                                          <span id="errorcrsdet" style="color:#ff0000;">&nbsp;</span>
                                        </dd>
                                      </dl>
                                    ...
                                    <form onsubmit="return crsdetedtvalde();" action="<?= $_SERVER['PHP_SELF'] ?>" method="post">
                                      ...
                                      <dl class="dl-horizontal">
                                        ...
                                        <dd>
                                          ...
                                          <span id="errorcrsdetedt" style="color:#ff0000;">&nbsp;</span>
                                        </dd>
                                      </dl>
                                    ...
                                    <form onsubmit="return videoslnkvalde();" action="<?= $_SERVER['PHP_SELF'] ?>" method="post">
                                      ...
                                      <dl class="dl-horizontal">
                                        ...
                                        <dd>
                                          ...
                                          <span id="errorvideosofclasses" style="color:#ff0000;">&nbsp;</span>
                                        </dd>
                                      </dl>
                                      <div class="m-t-30">
                                    ...
                                    <form onsubmit="return videoslnkeditvalde();" action="<?= $_SERVER['PHP_SELF'] ?>" method="post">
                                      ...
                                      <dl class="dl-horizontal">
                                        ...
                                        <dd>
                                          ...
                                          <span id="erroreditvideosofclasses" style="color:#ff0000;">&nbsp;</span>
                                        </dd>
                                      </dl>
                                      <div class="m-t-30">
                                    ...
                                    <form onsubmit="return pstleclnkvalde();" action="<?= $_SERVER['PHP_SELF'] ?>" method="post">
                                      ...
                                      <dl class="dl-horizontal">
                                        ...
                                        <dd>
                                          ...
                                          <span id="errorlnkfrrecvdo" style="color:#ff0000;">&nbsp;</span>
                                        </dd>
                                      </dl>
                                      <div class="m-t-30">
                                    ...
                                    <form onsubmit="return editpstleclnkvalde();" action="<?= $_SERVER['PHP_SELF'] ?>" method="post">
                                      ...
                                      <dl class="dl-horizontal">
                                        ...
                                        <dd>
                                          ...
                                          <span id="erroreditlnkfrrecvdo" style="color:#ff0000;">&nbsp;</span>
                                        </dd>
                                      </dl>
                                      <div class="m-t-30">
                                    ...
                                    <form onsubmit="return lnkfrvidclsvalde();" action="<?= $_SERVER['PHP_SELF'] ?>" method="post">
                                      ...
                                      <dl class="dl-horizontal">
                                        ...
                                        <dd>
                                          ...
                                          <span id="errorlnktorecvdo" style="color:#ff0000;">&nbsp;</span>
                                        </dd>
                                      </dl>
                                    ...
                                    <form onsubmit="return lnkfrtwovalde();" action="<?= $_SERVER['PHP_SELF'] ?>" method="post">
                                      ...
                                      <dl class="dl-horizontal">
                                        ...
                                        <dd>
                                          ...
                                          <span id="erroreditlnktorecvdo" style="color:#ff0000;">&nbsp;</span>
                                        </dd>
                                      </dl>
                                      ...
                                      <tbody>
                                        ...
                                        ?>
                                          <tr>
                                            ...
                                            <td><?php if ($viewschools['status'] == 1) {
                                                  echo "Public";
                                                } else if ($viewschools['status'] == 2) {
                                                  echo "Private";
                                                } else {
                                                  echo "Friends";
                                                } ?></td>
                            ...
                            <?php } else { ?>
                              <form name="schoolsform" id="schoolsform" onsubmit="return check9();" action="<?= $_SERVER['PHP_SELF'] ?>" method="post" style="margin-top: 15px;">
                                <input type="hidden" name="schoolspanel" value="1" />
                                ...
                                <div class="pmbb-edit" style="display:block;">
                                  <dl class="dl-horizontal">
                                    ...
                                    <dd>
                                      ...
                                      <span id="prgrmerr" style="color:#ff0000;">&nbsp;</span>
                                    </dd>
                                  </dl>
                                  <dl class="dl-horizontal">
                            ...
                            <?php } ?>
                            <form name="schoolsform" id="schoolsform" onsubmit="return Submitschools3();" enctype="multipart/form-data" action="<?= $_SERVER['PHP_SELF'] ?>" method="post" style="margin-top: 15px;">
                              <input type="hidden" name="schoolspanel" value="1" />
                              <div class="pmbb-edit">
                                <dl class="dl-horizontal">
                                  <dt class="p-t-10">Academic Programs*</dt>
                                  <dd>
                                    ...
                                    <span id="schools_error3" style="color:#ff0000;">&nbsp;</span>
                                  </dd>
                                </dl>
                                <dl class="dl-horizontal">
                                  <dt class="p-t-10">Course/Program Bulletin</dt>
                ...
                <div>
                  <h4 id="aff" class="btn btn-success"><a style="cursor:pointer; color:#FFF;">Affiliate Information</a><i class="fa fa-plus-circle" aria-hidden="true"></i></h4>
                </div>
                      ...
                      <div class="panel-body">
                        <div class="pmb-block p-10  m-b-0">
                          <div class="pmbb-body p-l-0">
                                    ...
                                    <form onsubmit="return crsivalde();" action="<?= $_SERVER['PHP_SELF'] ?>" method="post">
                                      ...
                                      <dl class="dl-horizontal">
                                        ...
                                        <dd>
                                          ...
                                          <span id="errorcrsi" style="color:#ff0000;">&nbsp;</span>
                                        </dd>
                                      </dl>
                                      <div class="m-t-30">
                                    ...
                                    <form onsubmit="return crsiedtvalde();" action="<?= $_SERVER['PHP_SELF'] ?>" method="post">
                                      ...
                                      <dl class="dl-horizontal">
                                        ...
                                        <dd>
                                          ...
                                          <span id="errorcrsiedt" style="color:#ff0000;">&nbsp;</span>
                                        </dd>
                                      </dl>
                                      <div class="m-t-30">
                                    ...
                                    <form onsubmit="return crsdetivalde();" action="<?= $_SERVER['PHP_SELF'] ?>" method="post">
                                      ...
                                      <dl class="dl-horizontal">
                                        ...
                                        <dd>
                                          ...
                                          <span id="errorcrsdeti" style="color:#ff0000;">&nbsp;</span>
                                        </dd>
                                      </dl>
                                    ...
                                    <form onsubmit="return crsdetedtivalde();" action="<?= $_SERVER['PHP_SELF'] ?>" method="post">
                                      ...
                                      <dl class="dl-horizontal">
                                        ...
                                        <dd>
                                          ...
                                          <span id="errorcrsdetedti" style="color:#ff0000;">&nbsp;</span>
                                        </dd>
                                      </dl>
                                    ...
                                    <form onsubmit="return videoslnkivalde();" action="<?= $_SERVER['PHP_SELF'] ?>" method="post">
                                      ...
                                      <dl class="dl-horizontal">
                                        ...
                                        <dd>
                                          ...
                                          <span id="errorvideosofclassesi" style="color:#ff0000;">&nbsp;</span>
                                        </dd>
                                      </dl>
                                      <div class="m-t-30">
                                    ...
                                    <form onsubmit="return videoslnkeditivalde();" action="<?= $_SERVER['PHP_SELF'] ?>" method="post">
                                      ...
                                      <dl class="dl-horizontal">
                                        ...
                                        <dd>
                                          ...
                                          <span id="erroreditvideosofclassesi" style="color:#ff0000;">&nbsp;</span>
                                        </dd>
                                      </dl>
                                      <div class="m-t-30">
                                    ...
                                    <form onsubmit="return lnkfrvidclsivalde();" action="<?= $_SERVER['PHP_SELF'] ?>" method="post">
                                      ...
                                      <dl class="dl-horizontal">
                                        ...
                                        <dd>
                                          ...
                                          <span id="errorlnktorecvdoi" style="color:#ff0000;">&nbsp;</span>
                                        </dd>
                                      </dl>
                                    ...
                                    <form onsubmit="return lnkfrtwoivalde();" action="<?= $_SERVER['PHP_SELF'] ?>" method="post">
                                      ...
                                      <dl class="dl-horizontal">
                                        ...
                                        <dd>
                                          ...
                                          <span id="erroreditlnktorecvdoi" style="color:#ff0000;">&nbsp;</span>
                                        </dd>
                                      </dl>
                                    ...
                                    <form onsubmit="return pstleclnkivalde();" action="<?= $_SERVER['PHP_SELF'] ?>" method="post">
                                      ...
                                      <dl class="dl-horizontal">
                                        ...
                                        <dd>
                                          ...
                                          <span id="errorlnkfrrecvdoi" style="color:#ff0000;">&nbsp;</span>
                                        </dd>
                                      </dl>
                                      <div class="m-t-30">
                                    ...
                                    <form onsubmit="return editpstleclnkivalde();" action="<?= $_SERVER['PHP_SELF'] ?>" method="post">
                                      ...
                                      <dl class="dl-horizontal">
                                        ...
                                        <dd>
                                          ...
                                          <span id="erroreditlnkfrrecvdoi" style="color:#ff0000;">&nbsp;</span>
                                        </dd>
                                      </dl>
                                      <div class="m-t-30">
                                      ...
                                      <tbody>
                                        ...
                                        ?>
                                          <tr>
                                            ...
                                            <td><?php if ($viewaffiliateschools['status'] == 1) {
                                                  echo "Public";
                                                } else if ($viewaffiliateschools['status'] == 2) {
                                                  echo "Private";
                                                } else {
                                                  echo "Friends";
                                                } ?></td>
                                          ...
                                          <!--SUB LEVEL-->
                                          <tr style="display:none; background-color:#576042;" id="curriculumaa<?php echo $viewaffiliateschools['id'] ?>">
                                              ...
                                              <table class="table table-striped table-bordered table-advance table-hover" width="100%">
                                                <thead>
                                                  ...
                                                  ?>
                                                    ...
                                                    <!--Sub of the sub level-->
                                                    <tr style="display:none; background-color:#576042;" id="coudetailsi<?php echo $fetchcoursei['iascd_id'] ?>">
                                                      <td colspan="5" style="padding: 10px;">
                                                        <table class="table table-striped table-bordered table-advance table-hover" width="100%">
                                                          ...
                                                          <td><?= date('d-M-Y', strtotime($fetchcoudet['crs_schedule'])) ?></td>-->
                                                              ...
                                                              <tr style="display:none; background-color:#576042;" id="videoclassi<?php echo $fetchcoudeti['iaccd_id'] ?>">
                                                                <td colspan="8" style="padding: 10px;">
                                                                  <table class="table table-striped table-bordered table-advance table-hover" width="100%">
                                                                    <thead>
                                                                      <tr>
                                                                      ...
                                                                      ?>
                                                                        ...
                                                                        <tr style="display:none; background-color:#576042;" id="vid123456<?php echo $fetchcouvidei['iascdv_id'] ?>">
                            ...
                            <?php } else { ?>
                              <form name="affiliateschoolsform" id="affiliateschoolsform" onsubmit="return correctionediti();" action="<?= $_SERVER['PHP_SELF'] ?>" method="post" style="margin-top: 15px;">
                                <input type="hidden" name="affiliateschoolspanel" value="1" />
                                ...
                                <div class="pmbb-edit" style="display:block;">
                                  <dl class="dl-horizontal">
                                    ...
                                    <dd>
                                      ...
                                      <span id="errorrectifyi" style="color:#ff0000;">&nbsp;</span>
                                    </dd>
                                  </dl>
                                  <dl class="dl-horizontal">
                                    <dt class="p-t-10">Course/Program Bulletin</dt>
                            ...
                            <?php } ?>
                            <form name="affiliateschoolsform" id="affiliateschoolsform" enctype="multipart/form-data" onsubmit="return correctsubmit();" action="<?= $_SERVER['PHP_SELF'] ?>" method="post" style="margin-top: 15px;">
                              <input type="hidden" name="affiliateschoolspanel" value="1" />
                              <div class="pmbb-edit">
                                <dl class="dl-horizontal">
                                  <dt class="p-t-10">Academic Programs*</dt>
                                  <dd>
                                    ...
                                    <span id="errorcorrection" style="color:#ff0000;">&nbsp;</span>
                                  </dd>
                                </dl>
                                <dl class="dl-horizontal">
                                  <dt class="p-t-10">Course/Program Bulletin</dt>
                ...
                <div>
                  <h4 id="stud" class="btn btn-success"><a style="cursor:pointer; color:#FFF;">Students</a><i class="fa fa-plus-circle" aria-hidden="true"></i></h4>
                </div>
                      ...
                      <div class="panel-body">
                        <div class="pmb-block p-10  m-b-0">
                          <div class="pmbb-body p-l-0">
                                    ...
                                    <form onsubmit="return transcriptformvalidate();" action="<?= $_SERVER['PHP_SELF'] ?>" method="post">
                                      ...
                                      <dl class="dl-horizontal">
                                        ...
                                        <dd>
                                          ...
                                          <span id="errorstuid" style="color:#ff0000;">&nbsp;</span>
                                        </dd>
                                      </dl>
                                    ...
                                    <form onsubmit="return transcriptformvalidatei();" action="<?= $_SERVER['PHP_SELF'] ?>" method="post">
                                      ...
                                      <dl class="dl-horizontal">
                                        ...
                                        <dd>
                                          ...
                                          <span id="errorstuidi" style="color:#ff0000;">&nbsp;</span>
                                        </dd>
                                      </dl>
                            ...
                            <?php } else { ?>
                              <form name="studentformthirdsection" id="studentformthirdsection" onsubmit="return studentvaldeforthrdces();" action="<?= $_SERVER['PHP_SELF'] ?>" method="post" style="margin-top: 15px;">
                                <input type="hidden" name="cur_studentpanel" value="1" />
                                ...
                                <div class="pmbb-edit" style="display:block;">
                                  <dl class="dl-horizontal">
                                    ...
                                    <dd>
                                      ...
                                      <span id="cur_studenterror" style="color:#ff0000;">&nbsp;</span>
                                    </dd>
                                  </dl>
                                  <dl class="dl-horizontal">
                            ...
                            <?php } ?>
                            <form name="studentformthirdsection" id="studentformthirdsection" enctype="multipart/form-data" onsubmit="return Submitcur_student3();" action="<?= $_SERVER['PHP_SELF'] ?>" method="post" style="margin-top: 15px;">
                              <input type="hidden" name="cur_studentpanel" value="1" />
                              <div class="pmbb-edit">
                                <dl class="dl-horizontal">
                                  <dt class="p-t-10">Current Student*</dt>
                                  <dd>
                                    ...
                                    <span id="cur_studenterrori" style="color:#ff0000;">&nbsp;</span>
                                  </dd>
                                </dl>
                                <dl class="dl-horizontal">
                                  <dt class="p-t-10">Past Student</dt>
                ...
                <div>
                  <h4 id="market" class="btn btn-success"><a style="cursor:pointer; color:#FFF;">Marketing and Promotion</a><i class="fa fa-plus-circle" aria-hidden="true"></i></h4>
                </div>
                      ...
                      <div class="panel-body">
                        <div class="pmb-block p-10  m-b-0">
                          <div class="pmbb-body p-l-0">
                            ...
                            <?php } else { ?>
                              <form name="marketform" id="marketform" onsubmit="return check9();" action="<?= $_SERVER['PHP_SELF'] ?>" method="post" style="margin-top: 15px;">
                                ...
                                <div class="pmbb-edit" style="display:block;">
                                  <dl class="dl-horizontal">
                                    ...
                                    <dd>
                                      ...
                                      <span id="market_error3" style="color:#ff0000;">&nbsp;</span>
                                    </dd>
                                  </dl>
                                  <dl class="dl-horizontal">
                            ...
                            <?php } ?>
                            <form name="marketform" id="marketform" onsubmit="return Submitmarket3();" enctype="multipart/form-data" action="<?= $_SERVER['PHP_SELF'] ?>" method="post" style="margin-top: 15px;">
                              <input type="hidden" name="marketpanel" value="1" />
                              <div class="pmbb-edit">
                                <dl class="dl-horizontal">
                                  <dt class="p-t-10">Advertisements/Advertisement Materials *</dt>
                ...
                <h4 id="nws" style="padding-bottom:10px; cursor:pointer;" class="btn btn-success"><a style="color:#FFF;">News and Information</a><i class="fa fa-plus-circle" aria-hidden="true"></i></h4>
                      ...
                      <div class="panel-body">
                        <div class="pmb-block p-10  m-b-0">
                          <div class="pmbb-body p-l-0">
                            ...
                            <?php } else { ?>
                              <form name="newsform" id="newsform" onsubmit="return newsedit();" action="<?= $_SERVER['PHP_SELF'] ?>" method="post" style="margin-top: 15px;">
                                ...
                                <div class="pmbb-edit" style="display:block;">
                                  <dl class="dl-horizontal">
                                    ...
                                    <dd>
                                      ...
                                      <span id="errornews" style="color:#ff0000;">&nbsp;</span>
                                    </dd>
                                  </dl>
                                  <dl class="dl-horizontal">
                            ...
                            <?php } ?>
                            <form name="newsform" id="newsform" onsubmit="return newsadd();" enctype="multipart/form-data" action="<?= $_SERVER['PHP_SELF'] ?>" method="post" style="margin-top: 15px;">
                              <input type="hidden" name="newsainfopanel" value="1" />
                              <div class="pmbb-edit">
                                <dl class="dl-horizontal">
                                  <dt class="p-t-10">News Name*</dt>
                                  <dd>
                                    ...
                                    <span id="erroranewsadd" style="color:#ff0000;">&nbsp;</span>
                                  </dd>
                                </dl>
                                <dl class="dl-horizontal">
                                  <dt class="p-t-10">News Description</dt>
                ...
                <!--****News and Information on 17-08-2016 [SUPRATIM]****-->
                <div>
                  <h4 id="soc" class="btn btn-success"><a style="cursor:pointer; color:#FFF;">Link to NarrateMe Social Network Sites</a><i class="fa fa-plus-circle" aria-hidden="true"></i></h4>
                </div>
                      ...
                      <div class="panel-body">
                        <div class="pmb-block p-10  m-b-0">
                          <div class="pmbb-body p-l-0">
                            ...
                            <?php } else { ?>
                              <form name="friendsform" id="friendsform" onsubmit="return check9();" action="<?= $_SERVER['PHP_SELF'] ?>" method="post" style="margin-top: 15px;">
                                ...
                                <div class="pmbb-edit" style="display:block;">
                                  <dl class="dl-horizontal">
                                    ...
                                    <dd>
                                      ...
                                      <span id="friends_error3" style="color:#ff0000;">&nbsp;</span>
                                    </dd>
                                  </dl>
                                  <dl class="dl-horizontal">
                            ...
                            <?php } ?>
                            <form name="friendsform" id="friendsform" onsubmit="return Submitfriends3();" action="<?= $_SERVER['PHP_SELF'] ?>" method="post" style="margin-top: 15px;">
                              <input type="hidden" name="friendspanel" value="1" />
                              <div class="pmbb-edit">
                                <dl class="dl-horizontal">
                                  <dt class="p-t-10">Name*</dt>
