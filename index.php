...
<section class="banner-section">
    <div class="owl-carousel banner-carousel">
        <div class="owl-block">
            <img class="owl-img" src="https://images.unsplash.com/photo-1503423571797-2d2bb372094a?auto=format&fit=crop&q=80&w=1974&ixlib=rb-4.0.3&ixid=M3wxMjA3fDB8MHxwaG90by1wYWdlfHx8fGVufDB8fHx8fA%3D%3D" loading="lazy" alt="banner_img" />
        </div>
        <div class="owl-block">
            <img class="owl-img" src="https://images.unsplash.com/photo-1497366754035-f200968a6e72?auto=format&fit=crop&q=80&w=1738&ixlib=rb-4.0.3&ixid=M3wxMjA3fDB8MHxwaG90by1wYWdlfHx8fGVufDB8fHx8fA%3D%3D" loading="lazy" alt="banner_img" />
        </div>
    </div>
    ...
    <div class="banner-text">
        <h1>NarrateMe</h1>
        <p>
            Lorem ipsum dolor sit amet, consectetur adipiscing elit. Quisque laoreet pulvinar mollis. Aliquam erat volutpat. Pellentesque ac lacus sit amet diam pellentesque sodales ut vitae libero. Phasellus ornare semper ligula, quis congue ex lobortis facilisis. In euismod id nunc at tristique.
        </p>
    </div>
</section>
...
<style>
    ...
    .banner-section .owl-carousel .owl-img {
        height: 100%;
    }
    ...
    .Product_Container .Product-carousel {
        overflow: hidden;
        height: 400px;
        position: absolute;
        top: 70px;
    ...
    .Product_Container .Product-carousel .owl-img {
        height: 400px;
        object-fit: cover;
        border-radius: 15px;
    }

    .Product_Container .Product-carousel .owl-block {
        position: relative;
        display: flex;
        align-items: center;
    ...
    .Product_Container .Product-carousel .owl-block .owl-Text {
        position: absolute;
        padding: 10px;
        height: 100%;
        width: 100%;
    ...
    .Product_Container .Product-carousel .owl-block .owl-Text p.Block-Heading {
        font-size: 20px;
        font-weight: 600;
        color: #fff;
        text-align: center;
    ...
    .Product_Container .Product-carousel .owl-block .owl-Text p.Block-SubHeading {
        font-size: 15px;
        color: #fff;
        text-align: center;
        display: -webkit-box;
    ...
    .Product_Container .Product-carousel .owl-block .owl-cover {
        position: absolute;
        height: 100%;
        width: 100%;
        background: #000000;
    ...
    .Product_Container .Product-carousel .owl-block .owl-Text .rotateme {
    ...
    .testimonial-block .testimonial-block-data {
        margin: 100px 0;
        max-width: 75%;
    }
    ...
    .testimonial-block .testimonial-block-data .testimonial-block-text {
        margin: 0 0 30px 0;
    }

    .testimonial-block .testimonial-block-data .testimonial-block-img {
        height: 150px;
    }

    .testimonial-block .testimonial-block-data .testimonial-block-img .before\:from-indigo-500\/25::before {
        --tw-gradient-from: #cac9d075 var(--tw-gradient-from-position);
    }

    .testimonial-block .testimonial-block-data .testimonial-block-img .h-32 {
        height: 150px;
    }

    .testimonial-block .testimonial-block-data .testimonial-block-img .w-\[480px\] {
        width: 700px;
    }

    .testimonial-block .testimonial-block-data .testimonial-block-img .h-\[480px\] {
        height: 700px;
    }

    .testimonial-block .testimonial-block-data .testimonial-block-btn .text-xs {
        font-size: 13px;
    }

    .testimonial-block .testimonial-block-data .testimonial-block-btn .bg-indigo-500 {
        background-color: #576042;
    }

    .testimonial-block .testimonial-block-data .testimonial-block-btn button {
        display: flex;
        align-items: center;
        justify-content: center;
        height: 40px;
    ...
    .testimonial-block .testimonial-block-data .testimonial-block-btn .hover\:bg-indigo-100:hover {
    ...
    .Contact-Us .Contact-Us-Data p.Contact-Us-Data-SubHeading {
        font-size: 18px;
        line-height: 25px;
        font-weight: 500;
        margin-top: 10px;
    ...
    .Contact-Us .Contact-Us-Social a {
        margin-right: 15px;
    }

    .Contact-Us .Contact-Us-Social a:nth-last-child(1) {
        margin-right: 0;
    }

    .Contact-Us .Contact-Us-Social a img {
        width: 30px;
        object-fit: cover;
        border-radius: 5px;
    }
