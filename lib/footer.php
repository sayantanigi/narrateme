<div id="wb_LayoutGrid7">
  <div id="LayoutGrid7">
    <div class="row">
      <div class="col-1">
        <div id="wb_Text12"> <span class="foo-text">© Copyright 2016. All Right Researved. </span> </div>
      </div>
      <div class="col-2">
      ...
      <div class="modal-body">
        ...
        <div id="wb_Text1"> <span class="Item-Head_dark">Login to Your Account</span><br />
          <span class="Item-Head_dark" id="lg2" style="color:#F00;font-size: 15px;">
            ...
            ?>
          </span> <span class="Item-Head_dark" id="errorBoxusr" style="color:#F00;font-size: 15px;"></span> <br />
        </div>
        <input type="password" id="passfild" name="pass" value="" placeholder="Password">
        <label id="errorBoxpass"></label>
        <div id="wb_Text2"> <span class="Item-Head_dark">OR<br>
          <br>
          </span><span class="top-text"><a href="register.php"> Register / Sign Up</a></span><br />
          <br />
          <span class="top-text"> <a id="fgpas" href="forgetpassword.php">Forget Password</a></span> </div>
      </div>
    </div>
  </div>
</form>
