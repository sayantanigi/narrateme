    ...
    <div class="modal-content">
      <div class="modal-body">
        ...
        <div id="wb_Text2"> <span class="Item-Head_dark">OR<br>
          <br>
          </span><span class="top-text"><a href="<?php echo $baseurl?>register.php"> Register / Sign Up </a></span><br />
          <br />
          <span class="top-text"> <a id="fgpas" href="<?php echo $baseurl?>forgetpassword.php">Forget Password</a></span> </div>
      </div>
    </div>
  </div>
</form>
