          ...
          <div class="pmb-block">
            <div class="pmbb-header">
              <div class="panel-group" data-collapse-color="teal" id="accordionTeal" role="tablist" aria-multiselectable="true">
                <h4 id="search_m" style="padding-bottom:10px; cursor:pointer;" class="btn btn-success">
                  <a style="color:#FFF;">Search Members</a>
                ...
                <!-------- search individuals----------------->
                <h4 id="search_ind" style="cursor:pointer;" class="btn btn-success"><a style="color:#FFF;">Search Individuals</a>
                  <i class="fa fa-plus-circle" aria-hidden="true"></i>
                </h4>
                ...
                <!--============= Search students ============--->
                <h4 id="search_stu" style="cursor:pointer;" class="btn btn-success"><a style="color:#FFF;">Search Students</a><i class="fa fa-plus-circle" aria-hidden="true"></i></h4>
                ...
                <h4 id="search_edu_inst" style="cursor:pointer;" class="btn btn-success"><a style="color:#FFF;">Search Educational Institution</a>
                <i class="fa fa-plus-circle" aria-hidden="true"></i>
              </h4>
                ...
                <h4 id="search_inst_fac" style="cursor:pointer;" class="btn btn-success"><a style="color:#FFF;">Search Instructional Facilities and Schools</a><i class="fa fa-plus-circle" aria-hidden="true"></i></h4>
                ...
                <h4 id="search_prgm" style="cursor:pointer;" class="btn btn-success"><a style="color:#FFF;">Search Programs</a><i class="fa fa-plus-circle" aria-hidden="true"></i></h4>
                ...
                <h4 id="search_clas_lec" style="cursor:pointer;" class="btn btn-success"><a style="color:#FFF;">Search Classes & Lectures</a><i class="fa fa-plus-circle" aria-hidden="true"></i></h4>
