        ...
        <form method="post" action="<?php echo $_SERVER['PHP_SELF'] ?>" id="" onSubmit="return Submitpasscheck()">
          <div class="pmb-block">
            <div class="pmbb-header">
              <h2 style="font-size: 25px; font-weight:400;">Change Settings</h2>
            </div>
            <div class="pmbb-body">
              <?php
              ...
              <div class="pmbb-edit" style="display:block;">
                <form method="post" action="<?php echo $_SERVER['PHP_SELF'] ?>">
                  ...
                  <div class="m-t-30">
                    <button type="submit" class="btn btn-primary btn-sm" name="addsociallink" style="border-radius: 100px;">Save</button>
